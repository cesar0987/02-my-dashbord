...
export const Sidebar = () => {
  return (
        ...
        <div id="menu"
        style={{width:'400px'}} className="bg-gray-900 min-h-screen z-10 text-slate-300 w-64 left-0 h-screen overflow-y-scroll">

          <div id="logo" className="my-4 px-6">
              <h1 className="text-lg md:text-2xl font-bold text-white">Terracota<span className="text-blue-500">Construcciones</span>.</h1>
